...
function Mi(e, t, n, r, o) {
    ...
    if (s)
        ...
        Mi(o, t, n, "", function(u) {
            return u
        })) : o != null && (Ja(o) && (o = Og(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace(vc, "$&/") + "/") + e)),
        t.push(o)),
        1;
    if (s = 0,
    r = r === "" ? "." : r + ":",
...
function Nf(e, t, n) {
    ...
    for (r in t)
        Fg.call(t, r) && !$g.hasOwnProperty(r) && (o[r] = t[r]);
    if (e && e.defaultProps)
...
var Wt = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , wc = {};
function Wg(e) {
    return Ul.call(wc, e) ? !0 : Ul.call(yc, e) ? !1 : Vg.test(e) ? wc[e] = !0 : (yc[e] = !0,
    !1)
}
function Hg(e, t, n, r) {
    if (n !== null && n.type === 0)
...
var yt = Math.clz32 ? Math.clz32 : cv
  , av = Math.log
  , uv = Math.LN2;
function cv(e) {
    return e >>>= 0,
    e === 0 ? 32 : 31 - (av(e) / uv | 0) | 0
}
var vi = 64
  , yi = 4194304;
function xo(e) {
...
var rp, uu, op, ip, sp, ia = !1, wi = [], xn = null, Sn = null, En = null, Mo = new Map, Io = new Map, cn = [], hv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Nc(e, t) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function mv(e, t, n, r, o) {
    ...
    case "pointerover":
        var i = o.pointerId;
        return Mo.set(i, uo(Mo.get(i) || null, e, t, n, r, o)),
        !0;
    case "gotpointercapture":
...
function co(e, t) {
    ...
    ia || (ia = !0,
    Xe.unstable_scheduleCallback(Xe.unstable_NormalPriority, gv)))
}
function Do(e) {
    function t(o) {
        return co(o, e)
...
for (var Sl = 0; Sl < Uc.length; Sl++) {
    var El = Uc[Sl]
      , ty = El.toLowerCase()
      , ny = El[0].toUpperCase() + El.slice(1);
    Ln(ty, "on" + ny)
}
...
var So = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
  , ry = new Set("cancel close invalid load scroll toggle".split(" ").concat(So));
function Vc(e, t, n) {
...
function $o(e) {
    if (!e[Ei]) {
        ...
        jf.forEach(function(n) {
            n !== "selectionchange" && (ry.has(n) || Cl(n, !1, e),
            Cl(n, !0, e))
        });
...
function kl(e, t, n, r, o) {
    ...
    Yf(function() {
        ...
        if (!(t & 7)) {
            ...
            R && (cp && n.locale !== "ko" && (vr || R !== "onCompositionStart" ? R === "onCompositionEnd" && vr && (b = up()) : (vn = c,
            ...
            b ? R.data = b : (b = fp(n),
            b !== null && (R.data = b)))),
            (b = Uv ? Vv(e, n) : Wv(e, n)) && (u = rs(u, "onBeforeInput"),
...
var fa = typeof setTimeout == "function" ? setTimeout : void 0
  ...
  , ly = typeof queueMicrotask == "function" ? queueMicrotask : typeof Qc < "u" ? function(e) {
...
var to = Math.random().toString(36).slice(2)
  ...
  , pa = "__reactEvents$" + to
  , uy = "__reactListeners$" + to
  , cy = "__reactHandles$" + to;
function Vn(e) {
    var t = e[Rt];
    if (t)
        return t;
...
function Pp(e, t, n) {
    ...
    for (var o in r)
        if (!(o in t))
            throw Error(_(108, Yg(e) || "Unknown", o));
    return ce({}, n, r)
}
function ss(e) {
...
function Nu(e, t, n, r, o, i) {
    ...
    t.updateQueue = null,
    t.lanes = 0,
    Bi.current = e === null || e.memoizedState === null ? vy : yy,
    e = n(r, o),
    To) {
        i = 0;
        do {
...
var hs = {
  ...
  , vy = {
    ...
    useImperativeHandle: function(e, t, n) {
        return n = n != null ? n.concat([e]) : null,
        Ui(4194308, 4, Qp.bind(null, t, e), n)
    },
...
function th(e, t, n) {
    var r = !1
      , o = Rn
      , i = t.contextType;
    return typeof i == "object" && i !== null ? i = it(i) : (o = Be(t) ? er : _e.current,
    r = t.contextTypes,
...
function wa(e, t, n, r) {
    ...
    Cu(e);
    var i = t.contextType;
    typeof i == "object" && i !== null ? o.context = it(i) : (i = Be(t) ? er : _e.current,
    o.context = Hr(e, i)),
    o.state = e.memoizedState,
...
function cd(e, t, n, r, o) {
    ...
    t.stateNode === null)
        ...
        var a = s.context
          , u = n.contextType;
        typeof u == "object" && u !== null ? u = it(u) : (u = Be(n) ? er : _e.current,
        u = Hr(t, u));
        ...
        h = s.context,
        a = n.contextType,
        typeof a == "object" && a !== null ? a = it(a) : (a = Be(n) ? er : _e.current,
        a = Hr(t, a));
                ...
                e: {
                    ...
                    for (i in l)
                        if (l.hasOwnProperty(i)) {
                            ...
                            a != null && Bf(e, a)) : i === "children" ? typeof a == "string" ? (n !== "textarea" || a !== "") && Ao(e, a) : typeof a == "number" && Ao(e, "" + a) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (jo.hasOwnProperty(i) ? a != null && i === "onScroll" && oe("scroll", e) : a != null && nu(e, i, a, s))
                        }
                    switch (n) {
                    case "input":
                        mi(e),
            ...
            a !== null)
                try {
                    ...
                    for (s = 0; s < a.length; s += 2) {
                        var c = a[s]
                          , f = a[s + 1];
                        c === "style" ? Vf(o, f) : c === "dangerouslySetInnerHTML" ? Bf(o, f) : c === "children" ? Ao(o, f) : nu(o, c, f, u)
                    }
                    switch (l) {
                    case "input":
                        Yl(o, i);
...
function Pn(e) {
    return e.mode & 1 ? q & 2 && Ee !== 0 ? Ee & -Ee : fy.transition !== null ? (Hi === 0 && (Hi = tp()),
    Hi) : (e = ee,
    e !== 0 || (e = window.event,
...
function Ue(e, t) {
    ...
    e.callbackPriority !== t) {
        if (n != null && Tc(n),
        t === 1)
            e.tag === 0 ? dy(wd.bind(null, e)) : Tp(wd.bind(null, e)),
            ly(function() {
                !(q & 6) && In()
            }),
            n = null;
        ...
        if (t === 6)
            ...
            case 3:
                ...
                10 < t)) {
                    ...
                    e.timeoutHandle = fa(Un.bind(null, e, Fe, Ft), t);
                    break
                }
                Un(e, Fe, Ft);
                break;
            case 4:
                ...
                10 < r) {
                    e.timeoutHandle = fa(Un.bind(null, e, Fe, Ft), r);
                    break
                }
                Un(e, Fe, Ft);
                break;
...
function Fu() {
    (ye === 0 || ye === 3 || ye === 2) && (ye = 4),
    xe === null || !(rr & 268435455) && !(zs & 268435455) || dn(xe, Ee)
}
function ys(e, t) {
    var n = q;
    q |= 2;
...
function Ly(e, t, n) {
    ...
    xe === e && (Ee & n) === n && (ye === 4 || ye === 3 && (Ee & 130023424) === Ee && 500 > pe() - Mu ? Zn(e, 0) : Lu |= n),
    Ue(e, t)
}
function Ch(e, t) {
    t === 0 && (e.mode & 1 ? (t = yi,
...
kh = function(e, t, n) {
    if (e !== null)
        ...
        ze = !1,
        le && t.flags & 1048576 && Np(t, as, t.index);
    switch (t.lanes = 0,
    t.tag) {
    case 2:
        var r = t.type;
...
Us.prototype.render = Uu.prototype.render = function(e) {
...
;
Us.prototype.unmount = Uu.prototype.unmount = function() {
...
function Jy(e) {
    const t = S.forwardRef( (n, r) => {
        ...
        if (S.isValidElement(o)) {
            const s = r0(o)
              , l = n0(i, o.props);
            return o.type !== S.Fragment && (l.ref = r ? jh(r, s) : s),
            S.cloneElement(o, l)
        }
...
function t0(e) {
    return S.isValidElement(e) && typeof e.type == "function" && "__radixId"in e.type && e.type.__radixId === Ah
}
function n0(e, t) {
    const n = {
        ...t
...
var l0 = "DismissableLayer", La = "dismissableLayer.update", a0 = "dismissableLayer.pointerDownOutside", u0 = "dismissableLayer.focusOutside", Pd, Mh = S.createContext({
    layers: new Set,
    ...
    S.useEffect( () => {
        const b = () => d({});
        return document.addEventListener(La, b),
        () => document.removeEventListener(La, b)
    }
    , []),
    w.jsx(We.div, {
        ...a,
...
var p0 = Wu
  , h0 = Ih
  , On = globalThis != null && globalThis.document ? S.useLayoutEffect : () => {}
  , m0 = "Portal"
  , Fh = S.forwardRef( (e, t) => {
    var l;
    ...
    return s ? _h.createPortal(w.jsx(We.div, {
        ...r,
        ref: t
    }), s) : null
}
...
var C0 = Object.freeze({
  ...
  , k0 = "VisuallyHidden"
  , Qs = S.forwardRef( (e, t) => w.jsx(We.span, {
    ...e,
    ref: t,
    style: {
        ...C0,
...
var Bh = "ToastViewport"
  ...
  , Uh = S.forwardRef( (e, t) => {
    ...
    const v = S.useCallback( ({tabbingDirection: y}) => {
        const p = l().map(g => {
            ...
            const m = p => {
                ...
                if (p.key === "Tab" && !g) {
                    ...
                    const D = v({
                      ...
                      , Q = D.findIndex(L => L === R);
                    Dl(D.slice(Q + 1)) ? p.preventDefault() : A ? (k = u.current) == null || k.focus() : (b = c.current) == null || b.focus()
                }
            }
            ;
  ...
  , I0 = S.forwardRef( (e, t) => {
    ...
    S.useEffect( () => {
        ...
        if (L) {
            ...
            L.addEventListener(Ia, G),
            () => {
                L.removeEventListener(Ma, $),
                L.removeEventListener(Ia, G)
            }
        }
    }
    , [v.viewport, C, a, u, D]),
    ...
    S.useEffect( () => (A(),
    () => j()), [A, j]);
    const Q = S.useMemo( () => y ? qh(y) : null, [y]);
    return v.viewport ? w.jsxs(w.Fragment, {
        children: [Q && w.jsx(D0, {
            ...
            scope: n,
            onClose: z,
            children: si.createPortal(w.jsx(Ku.ItemSlot, {
                scope: n,
                children: w.jsx(p0, {
                    asChild: !0,
                    ...
                    children: w.jsx(We.li, {
                        ...
                        onPointerMove: ve(e.onPointerMove, L => {
                            ...
                            L.target.setPointerCapture(L.pointerId)) : (Math.abs(G) > F || Math.abs($) > F) && (g.current = null)
                        }
                        ),
                        onPointerUp: ve(e.onPointerUp, L => {
                            ...
                            G) {
                                ...
                                Nd(G, v.swipeDirection, v.swipeThreshold) ? Oi(A0, d, T, {
                                    discrete: !0
                                }) : Oi(j0, h, T, {
                                    discrete: !0
                                }),
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Q0 = S.forwardRef( ({color: e="currentColor", size: t=24, strokeWidth: n=2, absoluteStrokeWidth: r, className: o="", children: i, iconNode: s, ...l}, a) => S.createElement("svg", {
    ref: a,
    ...H0,
    width: t,
    height: t,
 ...
 */
const K0 = (e, t) => {
    const n = S.forwardRef( ({className: r, ...o}, i) => S.createElement(Q0, {
        ref: i,
        iconNode: t,
...
const Tw = V0
  , pm = S.forwardRef( ({className: e, ...t}, n) => w.jsx(Zh, {
    ref: n,
    className: Dn("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", e),
    ...t
}));
pm.displayName = Zh.displayName;
const Nw = sm("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full", {
    variants: {
        variant: {
  ...
  , hm = S.forwardRef( ({className: e, variant: t, ...n}, r) => w.jsx(Jh, {
    ref: r,
    className: Dn(Nw({
        variant: t
    }), e),
...
const Rw = S.forwardRef( ({className: e, ...t}, n) => w.jsx(nm, {
    ref: n,
    className: Dn("inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors group-[.destructive]:border-muted/40 hover:bg-secondary group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 group-[.destructive]:focus:ring-destructive disabled:pointer-events-none disabled:opacity-50", e),
    ...t
}));
Rw.displayName = nm.displayName;
const mm = S.forwardRef( ({className: e, ...t}, n) => w.jsx(rm, {
    ref: n,
    className: Dn("absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-red-300 hover:text-foreground group-[.destructive]:hover:text-red-50 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600", e),
    "toast-close": "",
    ...t,
    children: w.jsx(Y0, {
        className: "h-4 w-4"
...
mm.displayName = rm.displayName;
const gm = S.forwardRef( ({className: e, ...t}, n) => w.jsx(em, {
    ref: n,
    className: Dn("text-sm font-semibold", e),
    ...t
}));
gm.displayName = em.displayName;
const vm = S.forwardRef( ({className: e, ...t}, n) => w.jsx(tm, {
    ref: n,
    className: Dn("text-sm opacity-90", e),
    ...t
}));
...
var Ad = ["light", "dark"]
  ...
  , Lw = () => {
    var e;
    return (e = S.useContext(jw)) != null ? e : Aw
}
;
...
var Mw = e => {
  ...
  , Iw = Array(12).fill(0)
  , Dw = ({visible: e, className: t}) => O.createElement("div", {
...
var ix = e => {
    ...
    let {invert: h, toast: d, unstyled: x, interacting: v, setHeights: y, visibleToasts: m, heights: p, index: g, toasts: E, expanded: C, removeToast: k, defaultRichColors: b, closeButton: R, style: A, cancelButtonStyle: j, actionButtonStyle: z, className: D="", descriptionClassName: Q="", duration: L, position: G, gap: $, loadingIcon: V, expandByDefault: T, classNames: N, icons: M, closeButtonAriaLabel: W="Close toast", pauseWhenPageIsHidden: F} = e
      , [K,X] = O.useState(null)
      ...
      , di = O.useMemo( () => p.findIndex(B => B.toastId === d.id) || 0, [p, d.id])
      , hg = O.useMemo( () => {
        var B;
        return (B = d.closeButton) != null ? B : R
    }
    , [d.closeButton, R])
      , cc = O.useMemo( () => d.duration || L || Ld, [d.duration, L])
      , sl = O.useRef(0)
      , fr = O.useRef(0)
      , dc = O.useRef(0)
      , pr = O.useRef(null)
      , [mg,gg] = G.split("-")
      , fc = O.useMemo( () => p.reduce( (B, te, se) => se >= di ? B : B + te.height, 0), [p, di])
      , pc = Vw()
      , vg = d.invert || h
      , ll = Je === "loading";
    ...
    return O.createElement("li", {
        tabIndex: 0,
        ref: zn,
        className: dt(D, fg, N == null ? void 0 : N.toast, (t = d == null ? void 0 : d.classNames) == null ? void 0 : t.toast, N == null ? void 0 : N.default, N == null ? void 0 : N[Je], (n = d == null ? void 0 : d.classNames) == null ? void 0 : n[Je]),
        "data-sonner-toast": "",
        ...
        onPointerUp: () => {
            ...
            if (Jt || !dr)
                return;
            pr.current = null;
            let at = Number(((B = zn.current) == null ? void 0 : B.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0)
        ...
        onPointerMove: B => {
            ...
            let tn = B.clientY - pr.current.y
              ...
              , ut = (se = e.swipeDirections) != null ? se : ox(G);
    ...
    }, hg && !d.jsx ? O.createElement("button", {
        "aria-label": W,
        "data-disabled": ll,
        "data-close-button": !0,
        onClick: ll || !dr ? () => {}
    ...
    }, (i = M == null ? void 0 : M.close) != null ? i : Uw) : null, d.jsx || S.isValidElement(d.title) ? d.jsx ? d.jsx : typeof d.title == "function" ? d.title() : d.title : O.createElement(O.Fragment, null, Je || d.icon || d.promise ? O.createElement("div", {
        "data-icon": "",
        className: dt(N == null ? void 0 : N.icon, (s = d == null ? void 0 : d.classNames) == null ? void 0 : s.icon)
    }, d.promise || d.type === "loading" && !d.icon ? d.icon || yg() : null, d.type !== "loading" ? d.icon || (M == null ? void 0 : M[Je]) || Mw(Je) : null) : null, O.createElement("div", {
        "data-content": "",
        ...
        "data-description": "",
        className: dt(Q, pg, N == null ? void 0 : N.description, (u = d == null ? void 0 : d.classNames) == null ? void 0 : u.description)
    }, typeof d.description == "function" ? d.description() : d.description) : null), S.isValidElement(d.cancel) ? d.cancel : d.cancel && ji(d.cancel) ? O.createElement("button", {
        "data-button": !0,
        "data-cancel": !0,
        style: d.cancelButtonStyle || j,
        onClick: B => {
            var te, se;
            ji(d.cancel) && dr && ((se = (te = d.cancel).onClick) == null || se.call(te, B),
            en())
        }
        ,
        className: dt(N == null ? void 0 : N.cancelButton, (c = d == null ? void 0 : d.classNames) == null ? void 0 : c.cancelButton)
    }, d.cancel.label) : null, S.isValidElement(d.action) ? d.action : d.action && ji(d.action) ? O.createElement("button", {
        "data-button": !0,
        "data-action": !0,
...
var lx = S.forwardRef(function(e, t) {
    let {invert: n, position: r="bottom-right", hotkey: o=["altKey", "KeyT"], expand: i, closeButton: s, className: l, offset: a, mobileOffset: u, theme: c="light", richColors: f, duration: h, style: d, visibleToasts: x=qw, toastOptions: v, dir: y=Md(), gap: m=tx, loadingIcon: p, icons: g, containerAriaLabel: E="Notifications", pauseWhenPageIsHidden: C} = e
      , [k,b] = O.useState([])
    ...
    , []);
    return O.useEffect( () => De.subscribe(F => {
        if (F.dismiss) {
    ...
    O.createElement("section", {
        ...
        return k.length ? O.createElement("ol", {
            ...
            return O.createElement(ix, {
                ...
                heights: A.filter(Zt => Zt.position == J.position),
                setHeights: j,
                expandByDefault: i,
                gap: m,
                loadingIcon: p,
...
const fx = new Set(["top", "bottom"]);
function _t(e) {
    return fx.has(Gt(e)) ? "y" : "x"
}
function Zu(e) {
    return Xu(_t(e))
}
...
const Sx = e => ({
    ...
    async fn(t) {
        ...
        const R = E / 2 - C / 2
          ...
          , L = b / 2 - v[x] / 2 + R
          , G = $a(D, L, Q)
          , $ = !a.arrow && ro(o) != null && L !== G && i.reference[x] / 2 - (L < D ? j : z) - v[x] / 2 < 0
          , V = $ ? L < D ? L - D : L - Q : 0;
        return {
            [d]: h[d] + V,
            data: {
        ...
        async fn(t) {
            ...
            !A.every(L => L <= 0)) {
                ...
                const L = (((z = i.flip) == null ? void 0 : z.index) || 0) + 1
                  , G = b[L];
                if (G && (!(f === "alignment" ? p !== _t(G) : !1) || j.every(T => T.overflows[0] > 0 && _t(T.placement) === p)))
                    return {
                        data: {
                            index: L,
                            overflows: j
        ...
        async fn(t) {
            ...
            k && !h) {
                const j = Qe(c.left, 0)
                  ...
                  , D = Qe(c.top, 0)
                  , Q = Qe(c.bottom, 0);
                d ? R = x - 2 * (j !== 0 || z !== 0 ? j + z : Qe(c.left, c.right)) : b = v - 2 * (D !== 0 || Q !== 0 ? D + Q : Qe(c.top, c.bottom))
            }
            await a({
                ...t,
                availableWidth: R,
...
const Rx = new Set(["inline", "contents"]);
function ai(e) {
    const {overflow: t, overflowX: n, overflowY: r, display: o} = Ct(e);
    return /auto|scroll|overlay|hidden|clip/.test(t + r + n) && !Rx.has(o)
}
const _x = new Set(["table", "td", "th"]);
function Ox(e) {
    return _x.has(oo(e))
}
const jx = [":popover-open", ":modal"];
function Gs(e) {
    return jx.some(t => {
        try {
            return e.matches(t)
...
const Ax = ["transform", "translate", "scale", "rotate", "perspective"]
  , Lx = ["transform", "translate", "scale", "rotate", "perspective", "filter"]
  , Mx = ["paint", "layout", "strict", "content"];
function Ju(e) {
    const t = ec()
      , n = Et(e) ? Ct(e) : e;
    return Ax.some(r => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || Lx.some(r => (n.willChange || "").includes(r)) || Mx.some(r => (n.contain || "").includes(r))
}
function Ix(e) {
    let t = An(e);
    for (; Lt(t) && !qr(t); ) {
...
const Dx = new Set(["html", "body", "#document"]);
function qr(e) {
    return Dx.has(oo(e))
}
function Ct(e) {
...
function Sm(e) {
    const t = An(e);
    return qr(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Lt(t) && ai(t) ? t : Sm(t)
}
function Xo(e, t, n) {
    var r;
    t === void 0 && (t = []),
...
function Qx(e, t) {
    ...
    for (; Et(s) && !qr(s); ) {
        ...
        (i ? !a && !o : !a && l.position === "static" && !!o && Wx.has(o.position) || ai(s) && !a && bm(e, s)) ? r = r.filter(c => c !== s) : o = l,
        s = An(s)
    }
    return t.set(e, r),
    r
...
function Kx(e) {
    ...
    const s = [...n === "clippingAncestors" ? Gs(t) ? [] : Qx(t, this._c) : [].concat(n), r]
      , l = s[0]
      , a = s.reduce( (u, c) => {
        const f = Ud(t, c, o);
...
function Pm(e, t) {
    ...
    for (; r && Ox(r) && zl(r); )
        r = Vd(r, t);
    return r && qr(r) && zl(r) && !Ju(r) ? n : r || Ix(e) || n
}
...
function Jx(e, t) {
    ...
    function s(l, a) {
        ...
        !h || !d)
            return;
        const x = Ai(f)
          , v = Ai(o.clientWidth - (c + h))
          , y = Ai(o.clientHeight - (f + d))
          , m = Ai(c)
          , g = {
        ...
        function C(k) {
            ...
            b === 1 && !Tm(u, e.getBoundingClientRect()) && s(),
            E = !1
        }
        try {
...
function c1(e) {
    ...
    , [])
      ...
      , Q = S.useCallback( () => {
        ...
        l1(k.current, b.current, T).then(N => {
            const M = {
                ...N,
...
var rc = "PopperContent"
  ...
  , Im = S.forwardRef( (e, t) => {
    ...
    const {__scopePopper: n, side: r="bottom", sideOffset: o=0, align: i="center", alignOffset: s=0, arrowPadding: l=0, avoidCollisions: a=!0, collisionBoundary: u=[], collisionPadding: c=0, sticky: f="partial", hideWhenDetached: h=!1, updatePositionStrategy: d="optimized", onPlaced: x, ...v} = e
      ...
      , Q = {
        padding: j,
        boundary: z.filter(b1),
        altBoundary: D
    }
      , {refs: L, floatingStyles: G, placement: $, isPositioned: V, middlewareData: T} = c1({
        strategy: "fixed",
        placement: A,
...
var Vm = "Tooltip"
  ...
  , j1 = S.forwardRef( (e, t) => {
    ...
    return S.useEffect( () => () => document.removeEventListener("pointerup", f), [f]),
    w.jsx(T1, {
        asChild: !0,
        ...s,
        children: w.jsx(We.button, {
...
j1.displayName = Va;
var A1 = "TooltipPortal"
  , [kE,L1] = qs(A1, {
    forceMount: void 0
})
  , Zr = "TooltipContent"
  , Wm = S.forwardRef( (e, t) => {
    const n = L1(Zr, e.__scopeTooltip)
      , {forceMount: r=n.forceMount, side: o="top", ...i} = e
      , s = Zs(Zr, e.__scopeTooltip);
    return w.jsx(Hu, {
        present: r || s.open,
        children: s.disableHoverableContent ? w.jsx(Hm, {
            side: o,
            ...i,
            ref: t
        }) : w.jsx(M1, {
    ...
    , [f])
      , d = S.useCallback( (x, v) => {
        const y = x.currentTarget
          ...
          , p = $1(m, y.getBoundingClientRect())
          , g = B1(m, p)
          , E = U1(v.getBoundingClientRect())
          , C = W1([...g, ...E]);
        l(C),
        f(!0)
    }
...
var Qm = "TooltipArrow"
  , z1 = S.forwardRef( (e, t) => {
    const {__scopeTooltip: n, ...r} = e
      , o = oc(n);
    return D1(Qm, n).isInside ? null : w.jsx(R1, {
        ...o,
        ...r,
        ref: t
    })
...
var Q1 = Um
  , Km = Wm;
const K1 = Q1
  , Y1 = S.forwardRef( ({className: e, sideOffset: t=4, ...n}, r) => w.jsx(Km, {
    ref: r,
    sideOffset: t,
    className: Dn("z-50 overflow-hidden rounded-md border bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2", e),
    ...n
}));
Y1.displayName = Km.displayName;
var Js = class {
    constructor() {
...
var Qn, fn, Ir, af, rS = (af = class extends Js {
    constructor() {
        super();
        Z(this, Qn);
        Z(this, fn);
...
fn = new WeakMap,
Ir = new WeakMap,
af), Xm = new rS, Dr, pn, Fr, uf, oS = (uf = class extends Js {
    constructor() {
        super();
        Z(this, Dr, !0);
        Z(this, pn);
...
function Jm(e) {
    ...
    const i = iS()
      ...
      , u = () => Xm.isFocused() && (e.networkMode === "always" || bs.isOnline()) && e.canRun()
...
var Ae = aS(), Kn, cf, eg = (cf = class {
    ...
    scheduleGc() {
        this.clearGcTimeout(),
        X1(this.gcTime) && U(this, Kn, setTimeout( () => {
            this.optionalRemove()
        }
        , this.gcTime))
    }
...
,
Kn = new WeakMap,
cf), zr, Yn, et, Gn, Ne, Jo, Xn, ht, Dt, df, uS = (df = class extends eg {
    constructor(t) {
        super();
        Z(this, ht);
        Z(this, zr);
        ...
        this.observers = [],
        U(this, Gn, t.client),
        U(this, et, P(this, Gn).getQueryCache()),
        this.queryKey = t.queryKey,
        this.queryHash = t.queryHash,
        U(this, zr, dS(this.options)),
        this.state = t.state ?? P(this, zr),
        this.scheduleGc()
    }
    get meta() {
    ...
    setData(t, n) {
        ...
        return be(this, ht, Dt).call(this, {
            data: r,
            type: "success",
    ...
    isStaleByTime(t=0) {
        return this.state.data === void 0 ? !0 : t === "static" ? !1 : this.state.isInvalidated ? !0 : !q1(this.state.dataUpdatedAt, t)
    }
    onFocus() {
        var n;
    ...
    invalidate() {
        this.state.isInvalidated || be(this, ht, Dt).call(this, {
            type: "invalidate"
        })
    }
    fetch(t, n) {
        ...
        (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((c = l.fetchOptions) == null ? void 0 : c.meta)) && be(this, ht, Dt).call(this, {
            type: "fetch",
            meta: (f = l.fetchOptions) == null ? void 0 : f.meta
        });
        const a = h => {
            var d, x, v, y;
            Bl(h) && h.silent || be(this, ht, Dt).call(this, {
                type: "error",
                error: h
            }),
            Bl(h) || ((x = (d = P(this, et).config).onError) == null || x.call(d, h, this),
            (y = (v = P(this, et).config).onSettled) == null || y.call(v, this.state.data, h, this)),
            this.scheduleGc()
        }
        ;
        return U(this, Ne, Jm({
            ...
            onSuccess: h => {
                ...
                (x = (d = P(this, et).config).onSuccess) == null || x.call(d, h, this),
                (y = (v = P(this, et).config).onSettled) == null || y.call(v, h, this.state.error, this),
                this.scheduleGc()
            }
            ,
            onError: a,
...
var Pt, ff, fS = (ff = class extends Js {
    constructor(t={}) {
        super();
        Z(this, Pt);
        this.config = t,
    ...
    add(t) {
        P(this, Pt).has(t.queryHash) || (P(this, Pt).set(t.queryHash, t),
        this.notify({
            type: "added",
            query: t
        }))
...
,
Pt = new WeakMap,
ff), Tt, Oe, qn, Nt, ln, pf, pS = (pf = class extends eg {
    constructor(t) {
        super();
        Z(this, Nt);
        Z(this, Tt);
    ...
    addObserver(t) {
        P(this, Tt).includes(t) || (P(this, Tt).push(t),
        this.clearGcTimeout(),
        P(this, Oe).notify({
            type: "observerAdded",
            mutation: this,
    ...
    removeObserver(t) {
        U(this, Tt, P(this, Tt).filter(n => n !== t)),
        this.scheduleGc(),
        P(this, Oe).notify({
            type: "observerRemoved",
            mutation: this,
    ...
    optionalRemove() {
        P(this, Tt).length || (this.state.status === "pending" ? this.scheduleGc() : P(this, Oe).remove(this))
    }
    continue() {
        var t;
    ...
    async execute(t) {
        ...
        try {
            if (r)
                ...
                j !== this.state.context && be(this, Nt, ln).call(this, {
                    type: "pending",
                    context: j,
                    variables: t,
                    isPaused: o
            ...
            await ((x = (d = P(this, Oe).config).onSettled) == null ? void 0 : x.call(d, A, null, this.state.variables, this.state.context, this)),
            ...
            try {
                ...
                await ((k = (C = P(this, Oe).config).onSettled) == null ? void 0 : k.call(C, void 0, A, this.state.variables, this.state.context, this)),
...
var $t, mt, ei, hf, mS = (hf = class extends Js {
    constructor(t={}) {
        super();
        Z(this, $t);
        Z(this, mt);
...
var de, hn, mn, $r, Br, gn, Ur, Vr, mf, vS = (mf = class {
    constructor(e={}) {
        Z(this, de);
        Z(this, hn);
        Z(this, mn);
        ...
        U(this, hn, e.mutationCache || new mS),
    ...
    mount() {
        ...
        P(this, gn) === 1 && (U(this, Ur, Xm.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            P(this, de).onFocus())
        }
        )),
        U(this, Vr, bs.subscribe(async e => {
            e && (await this.resumePausedMutations(),
            P(this, de).onOnline())
        }
        )))
    ...
    unmount() {
        ...
        P(this, gn) === 0 && ((e = P(this, Ur)) == null || e.call(this),
        U(this, Ur, void 0),
    ...
    resumePausedMutations() {
        return bs.isOnline() ? P(this, hn).resumePausedMutations() : Promise.resolve()
    }
    getQueryCache() {
        return P(this, de)
    }
...
Ur = new WeakMap,
Vr = new WeakMap,
mf), yS = S.createContext(void 0), wS = ({client: e, children: t}) => (S.useEffect( () => (e.mount(),
() => {
    e.unmount()
}
), [e]),
...
function xS(e) {
    ...
    function n(r, o) {
        return typeof o == "string" ? o : ng(o)
    }
    return ES(t, n, null, e)
}
function Ve(e, t) {
...
function bS(e) {
    e.sort( (t, n) => t.score !== n.score ? n.score - t.score : AS(t.routesMeta.map(r => r.childrenIndex), n.routesMeta.map(r => r.childrenIndex)))
}
const PS = /^:[\w-]+$/
  , TS = 3
  , NS = 2
...
function jS(e, t) {
    let n = e.split("/")
      , r = n.length;
    return n.some(nf) && (r += OS),
    t && (r += NS),
    n.filter(o => !nf(o)).reduce( (o, i) => o + (PS.test(i) ? TS : i === "" ? RS : _S), r)
}
function AS(e, t) {
...
function LS(e, t, n) {
    ...
    for (let l = 0; l < r.length; ++l) {
        ...
        s.push({
            ...
            pathnameBase: DS(Mr([i, f.pathnameBase])),
            route: h
        }),
...
function MS(e, t, n) {
    t === void 0 && (t = !1),
    n === void 0 && (n = !0),
    tg(e === "*" || !e.endsWith("*") || e.endsWith("/*"), 'Route path "' + e + '" will be treated as if it were ' + ('"' + e.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + e.replace(/\*$/, "/*") + '".'));
    let r = []
...
function IS(e) {
    try {
        ...
        return tg(!1, 'The URL path "' + e + '" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent ' + ("encoding (" + t + ").")),
        e
    }
}
function ig(e, t) {
...
function VS(e, t, n, r) {
    lc() || Ve(!1);
    let {navigator: o} = S.useContext(lg)
    ...
    return t && v ? S.createElement(nl.Provider, {
        value: {
            location: Ts({
                pathname: "/",
                search: "",
...
const HS = S.createElement(WS, null);
class QS extends S.Component {
    ...
    render() {
        return this.state.error !== void 0 ? S.createElement(rl.Provider, {
            value: this.props.routeContext
        }, S.createElement(ag.Provider, {
...
function YS(e, t, n, r) {
    ...
    return s.reduceRight( (c, f, h) => {
        ...
        let m = t.concat(s.slice(0, h + 1))
          , p = () => {
            let g;
            return d ? g = v : x ? g = y : f.route.Component ? g = S.createElement(f.route.Component, null) : f.route.element ? g = f.route.element : g = c,
            S.createElement(KS, {
                match: f,
                routeContext: {
                    outlet: c,
        ...
        ;
        return n && (f.route.ErrorBoundary || f.route.errorElement || h === 0) ? S.createElement(QS, {
            location: n.location,
...
function ZS() {
    var e;
    let t = S.useContext(ag)
      , n = GS(Ka.UseRouteError)
      , r = qS(Ka.UseRouteError);
...
function eE(e) {
    ...
    , [a, c, f, h, d, x, o]);
    return v == null ? null : S.createElement(lg.Provider, {
        value: u
...
const iE = "/assets/hero-computer-CwIQnPtX.png"
  , sE = sm("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        variant: {
  ...
  , Ns = S.forwardRef( ({className: e, variant: t, size: n, asChild: r=!1, ...o}, i) => {
    const s = r ? Zy : "button";
    return w.jsx(s, {
        className: Dn(sE({
            variant: t,
...
const lE = () => w.jsx("section", {
    ...
    children: w.jsx("div", {
        ...
        children: w.jsxs("div", {
            ...
            children: [w.jsxs("div", {
                className: "space-y-6 tape",
                children: [w.jsx("div", {
                    className: "inline-block paper-cutout px-6 py-3 rotate-1",
                    children: w.jsx("p", {
                    ...
                    children: [w.jsx("span", {
                        ...
                        className: "block marker-highlight",
                    ...
                    className: "paper-cutout p-6 -rotate-1 torn-edge",
                    children: w.jsxs("p", {
                        className: "text-lg leading-relaxed",
                        children: ["I create ", w.jsx("strong", {
                            children: "retro-futuristic collages"
                        }), " that blend 90s nostalgia with modern editorial design. Specializing in bold typography, experimental layouts, and unapologetically vibrant aesthetics."]
                    })
                }), w.jsxs("div", {
                    className: "flex gap-4 flex-wrap",
                    children: [w.jsx(Ns, {
                        size: "lg",
                        className: "bg-primary hover:bg-primary/90 text-primary-foreground font-black uppercase tracking-wider border-4 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all",
                        children: "View Work"
                    }), w.jsx(Ns, {
                        size: "lg",
                        variant: "outline",
                        className: "bg-secondary hover:bg-secondary/90 text-secondary-foreground font-black uppercase tracking-wider border-4 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all",
                        children: "Get in Touch"
                    })]
                })]
            }), w.jsxs("div", {
                className: "relative paperclip",
                children: [w.jsx("div", {
                    className: "sticker paper-cutout p-4 bg-primary",
                    children: w.jsx("img", {
                        src: iE,
                        alt: "Vintage 90s computer with graphic design software",
                        className: "w-full h-auto rounded"
                    })
                }), w.jsx("div", {
                    className: "absolute -top-8 -right-8 paper-cutout bg-accent text-accent-foreground px-4 py-2 rotate-12 font-black text-sm",
                    children: "EST. 2020"
                }), w.jsx("div", {
                    className: "absolute -bottom-6 -left-6 paper-cutout bg-secondary px-6 py-3 -rotate-6 font-black",
                    children: "CREATIVE"
                })]
            })]
        })
    ...
    children: w.jsx("div", {
        ...
        children: w.jsxs("div", {
            ...
            children: [w.jsxs("div", {
                className: "space-y-8",
                children: [w.jsxs("div", {
                    className: "paper-cutout p-8 rotate-1 tape",
                    children: [w.jsxs("h2", {
                        className: "mb-4",
                        children: ["About ", w.jsx("span", {
                            className: "marker-highlight",
                            children: "Me"
                        })]
                    }), w.jsx("p", {
                        className: "text-lg leading-relaxed mb-4",
                        children: "I'm a multi-disciplinary designer who believes rules are meant to be broken (tastefully). My work combines analog collage techniques with digital precision."
                    }), w.jsx("p", {
                        className: "leading-relaxed text-muted-foreground",
                        children: "With 5+ years of experience, I've worked with indie brands, music labels, and creative studios who aren't afraid to stand out."
                    })]
                }), w.jsxs("div", {
                    className: "paper-cutout p-6 bg-accent text-accent-foreground -rotate-2 paperclip",
                    children: [w.jsx("h3", {
                        ...
                        children: [w.jsx("li", {
                            children: "✦ Embrace imperfection"
                        }), w.jsx("li", {
                            children: "✦ Challenge conventions"
                        }), w.jsx("li", {
                            children: "✦ Create with purpose"
                        }), w.jsx("li", {
                            children: "✦ Stay authentic"
                        })]
                    })]
                })]
            }), w.jsxs("div", {
                ...
                children: [w.jsxs("div", {
                    ...
                    children: [w.jsxs("div", {
                        className: "paper-cutout p-6 text-center rotate-2 bg-primary",
                        children: [w.jsx("div", {
                        ...
                        className: "paper-cutout p-6 text-center -rotate-1 bg-secondary",
                        children: [w.jsx("div", {
                            className: "text-4xl font-black mb-2",
                            children: "20+"
                        }), w.jsx("div", {
                        ...
                        className: "paper-cutout p-6 text-center -rotate-2 bg-accent text-accent-foreground",
                        children: [w.jsx("div", {
                            className: "text-4xl font-black mb-2",
                            children: "5+"
                        }), w.jsx("div", {
                        ...
                        className: "paper-cutout p-6 text-center rotate-1 bg-card",
                        children: [w.jsx("div", {
                            className: "text-4xl font-black mb-2",
                            children: "∞"
                        }), w.jsx("div", {
                    ...
                    className: "paper-cutout p-8 -rotate-1 torn-edge",
                    children: [w.jsx("h3", {
                        ...
                        children: [w.jsxs("div", {
                            ...
                            children: [w.jsx("div", {
                                ...
                                children: "Brand Identity & Visual Systems"
                            })]
                        }), w.jsxs("div", {
                            className: "flex items-center gap-3",
                            children: [w.jsx("div", {
                                className: "w-3 h-3 bg-secondary rotate-45"
                            }), w.jsx("span", {
                                children: "Editorial Design & Layouts"
                            })]
                        }), w.jsxs("div", {
                            className: "flex items-center gap-3",
                            children: [w.jsx("div", {
                                className: "w-3 h-3 bg-accent rotate-45"
                            }), w.jsx("span", {
                                children: "Poster & Print Design"
                            })]
                        }), w.jsxs("div", {
                            className: "flex items-center gap-3",
                            children: [w.jsx("div", {
                                ...
                                children: "Art Direction & Creative Strategy"
                            })]
                        })]
                    })]
                })]
  ...
  , uE = [{
    title: "INDIE MUSIC LABEL",
    category: "Branding",
    description: "Complete visual identity with album artwork and promotional materials",
    color: "bg-primary",
    rotation: "rotate-2"
}, {
    title: "STREET WEAR BRAND",
    category: "Art Direction",
    description: "Bold campaign visuals mixing analog and digital techniques",
    color: "bg-secondary",
    rotation: "-rotate-1"
}, {
    title: "DESIGN MAGAZINE",
    category: "Editorial",
    description: "Experimental layout design for quarterly print publication",
    color: "bg-accent",
    rotation: "rotate-1"
}, {
    title: "CREATIVE FESTIVAL",
    category: "Poster Design",
    description: "Series of large-format posters with collage aesthetics",
    color: "bg-primary",
    rotation: "-rotate-2"
}, {
    title: "TECH STARTUP",
    category: "Brand Identity",
    description: "Modern retro identity system with vintage computer elements",
    color: "bg-secondary",
    rotation: "rotate-3"
}, {
    title: "ART EXHIBITION",
    category: "Creative Direction",
    description: "Full exhibition design with signage and promotional materials",
    color: "bg-accent",
    rotation: "-rotate-1"
}]
  , cE = () => w.jsx("section", {
    ...
    children: w.jsxs("div", {
        className: "container max-w-6xl",
        children: [w.jsx("div", {
            className: "text-center mb-16 tape",
            children: w.jsx("div", {
                className: "inline-block paper-cutout px-8 py-4 rotate-1 bg-card",
                children: w.jsxs("h2", {
                    children: ["Selected ", w.jsx("span", {
                        className: "marker-highlight",
                        children: "Work"
                    })]
                })
            ...
            children: uE.map( (e, t) => w.jsx("div", {
                className: `sticker paper-cutout p-6 ${e.color} ${e.rotation} cursor-pointer group`,
                children: w.jsxs("div", {
                    className: "space-y-3",
                    children: [w.jsxs("div", {
                        className: "flex items-start justify-between",
                        children: [w.jsx("span", {
                            className: "inline-block px-3 py-1 bg-foreground text-background text-xs font-black uppercase",
                            children: e.category
                        }), w.jsx("span", {
                        ...
                        className: "pt-2 border-t-2 border-foreground",
                        children: w.jsx("span", {
            ...
            children: w.jsx("div", {
                className: "inline-block paper-cutout px-8 py-4 -rotate-1 bg-primary hover:rotate-0 transition-transform cursor-pointer",
                children: w.jsx("span", {
  ...
  , dE = "/assets/software-icons-JuBtuFr_.png"
  , fE = [{
    name: "Photoshop",
    level: "Expert"
}, {
    ...
    children: w.jsx("div", {
        ...
        children: w.jsxs("div", {
            ...
            children: [w.jsxs("div", {
                className: "relative paperclip",
                children: [w.jsx("div", {
                    className: "paper-cutout p-8 rotate-2 bg-secondary",
                    children: w.jsx("img", {
                        src: dE,
                        alt: "Vintage design software icons stickers",
                        className: "w-full h-auto"
                    })
                }), w.jsx("div", {
                    className: "absolute -bottom-4 -right-4 paper-cutout bg-accent text-accent-foreground px-6 py-3 -rotate-6 font-black text-sm",
                ...
                children: [w.jsxs("div", {
                    ...
                    children: [w.jsxs("h2", {
                        className: "mb-6",
                        children: ["Skills & ", w.jsx("span", {
                            className: "marker-highlight",
                            children: "Tools"
                        })]
                    }), w.jsx("div", {
                        className: "space-y-4",
                        children: fE.map( (e, t) => w.jsxs("div", {
                            className: "space-y-2",
                            children: [w.jsxs("div", {
                                ...
                                children: [w.jsx("span", {
                                    ...
                                    className: "text-sm bg-foreground text-background px-3 py-1 font-black",
                                    children: e.level
                                })]
                            }), w.jsx("div", {
                                className: "h-3 bg-muted border-2 border-foreground relative overflow-hidden",
                                children: w.jsx("div", {
                                    className: `h-full ${t % 3 === 0 ? "bg-primary" : t % 3 === 1 ? "bg-secondary" : "bg-accent"}`,
                                    style: {
                                        width: e.level === "Expert" ? "95%" : e.level === "Advanced" ? "80%" : "65%",
                    ...
                    className: "paper-cutout p-6 bg-primary rotate-1 torn-edge",
                    children: [w.jsx("h3", {
                        className: "font-black mb-3 uppercase",
                        children: "Additional Skills"
                    }), w.jsx("div", {
                        className: "flex flex-wrap gap-2",
                        children: ["Typography", "Color Theory", "Layout Design", "Art Direction", "Print Production", "Brand Strategy"].map( (e, t) => w.jsx("span", {
                            className: "inline-block px-3 py-1 bg-foreground text-background text-xs font-bold uppercase",
                            children: e
                        }, t))
                    })]
                })]
  ...
  , hE = () => w.jsxs("section", {
    ...
    children: [w.jsx("div", {
        ...
        children: w.jsxs("div", {
            ...
            children: [w.jsx("div", {
                className: "inline-block paper-cutout px-8 py-4 rotate-1 bg-card tape",
                children: w.jsxs("h2", {
                    children: ["Let's ", w.jsx("span", {
                        className: "marker-highlight",
                        children: "Collaborate"
                    })]
                })
            }), w.jsxs("div", {
                className: "paper-cutout p-12 -rotate-1 paperclip",
                children: [w.jsxs("p", {
                    className: "text-xl leading-relaxed mb-8",
                    children: ["Got a bold project in mind? Need someone who's not afraid to push boundaries? Let's create something ", w.jsx("strong", {
                        children: "unforgettable"
                    }), " together."]
                }), w.jsxs("div", {
                    className: "flex flex-col sm:flex-row gap-4 justify-center items-center mb-8",
                    children: [w.jsx("div", {
                        className: "paper-cutout px-6 py-3 bg-primary rotate-2 font-bold",
                        children: "✉️ hello@designer.com"
                    }), w.jsx("div", {
                        className: "paper-cutout px-6 py-3 bg-secondary -rotate-2 font-bold",
                        children: "📱 +1 (555) 123-4567"
                    })]
                }), w.jsx(Ns, {
                    size: "lg",
                    className: "bg-accent hover:bg-accent/90 text-accent-foreground font-black uppercase tracking-wider border-4 border-foreground shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all text-lg px-12",
                ...
                children: [{
                    ...
                    className: `sticker paper-cutout px-4 py-2 bg-card text-sm font-bold cursor-pointer ${t % 2 === 0 ? "rotate-2" : "-rotate-2"}`,
                    children: [w.jsx("span", {
        ...
        className: "text-center mt-20 pt-8 border-t-4 border-foreground",
        children: w.jsx("div", {
            className: "inline-block paper-cutout px-6 py-3 bg-primary -rotate-1",
            children: w.jsx("p", {
                className: "font-black uppercase text-sm",
                children: "© 2025 Creative Designer. All Rights Reserved."
            })
        })
    })]
})
  , mE = () => w.jsxs("main", {
    children: [w.jsx(lE, {}), w.jsx(aE, {}), w.jsx(cE, {}), w.jsx(pE, {}), w.jsx(hE, {})]
})
  , gE = () => {
    const e = ug();
    return S.useEffect( () => {
  ...
  , yE = () => w.jsx(wS, {
    client: vE,
    children: w.jsxs(K1, {
        children: [w.jsx(_w, {}), w.jsx(ax, {}), w.jsx(oE, {
            children: w.jsxs(tE, {
                children: [w.jsx(Ya, {
                    path: "/",
                    element: w.jsx(mE, {})
...
Oh(document.getElementById("root")).render(w.jsx(yE, {}));
